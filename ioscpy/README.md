...
Keyboard, clipboard, and injected touches work as soon as the host is connected.
The tweak reads the digitizer identity from HID on load, so a physical tap after
respring is not required.
